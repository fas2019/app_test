		...
		<section>
			...
			<table class="table">
				<tr>
					...
					<th>observacion</th>
					<th>Ticket</th>
					<th> <a href="nuevo_viaje1.php"> <button type="button" class="btn btn-info">Nuevo</button> </a> </th>
				</tr>
				...
				while ($registroOrlando = $resOrlando->fetch_array(MYSQLI_BOTH))
				{
					...
					echo'<tr>
						 ...
						 <td>'.$registroOrlando['observacion'].'</td>
						 <td>'; echo "<img src='".$registroOrlando['ticket']."' width='60' >"; echo '</td>;
